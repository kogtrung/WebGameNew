    ...
    try
    {
        ...
        try
        {
            ...
            if (!hasGames)
            {
                ...
                try 
                {
                    // The actual seeding is handled by SeedData.Initialize and subsequent calls
                    logger.LogInformation("Skipping redundant SeedSampleData call, using SeedData.Initialize later.");
